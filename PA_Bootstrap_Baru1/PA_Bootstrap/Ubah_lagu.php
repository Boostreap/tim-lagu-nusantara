...
if (isset($_GET['id_lagu'])) {
    ...
    echo "<script>alert('ID Lagu tidak ditemukan!'); window.location.href = 'daftar_lagu_admin.php';</script>";
    exit;
}
...
if (isset($_POST['update_lagu'])) {
    ...
    $judul_lagu = $_POST['judul']; // Menggunakan nama 'judul' sesuai form tambah lagu
    $asal_daerah = $_POST['asal_daerah']; // Asal daerah
    $tanggal_rilis = $_POST['tanggal_lagu']; // Tanggal rilis
    $lirik_lagu = $_POST['lirik']; // Lirik lagu
    $deskripsi = $_POST['deskripsi']; // Deskripsi lagu
    $id_album = $_POST['id_album']; // ID album
    ...
    $sql = "UPDATE lagu 
            SET judul_lagu = '$judul_lagu', asal_daerah = '$asal_daerah', tanggal_rilis = '$tanggal_rilis', lirik_lagu = '$lirik_lagu', deskripsi = '$deskripsi', 
                file_sampul = '$file_sampul', file_lagu = '$file_lagu', id_album = '$id_album' 
